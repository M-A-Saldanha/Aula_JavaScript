...
const imparNumbers = randomNumbers.filter(getOddNumbers)
...
const countNumberLess501 = (accumulator,item) => item < 501 ? ++accumulator : accumulator


// accumulator++ é um pós incremento e o ++accumulator é um pré incremento

const sumNumbers = crazyNumbers.reduce(countNumberLess501,0)
...
const preTwoThousandMovies = tarantinoMovies.filter(({release}) => release < 2000)

console.log(preTwoThousandMovies)
...
const cartNames = cart.reduce((accumulator,{ name }) => `${accumulator}- ${name}\n`
,'')
